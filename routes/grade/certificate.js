...
const run = (req, res, next) => {
  ...
  utils.get(req, res, url, true)
    .then((rawData) => {
      ...
      let title, userinfo = [];
      let rawInfo = document.querySelectorAll("#Table3 > tbody > tr > td");
      ...
      let details = [];
      let gradeInfo = document.querySelector("table#dgList > tbody").children;
      ...
      let summary = [];
      let summaryTable = document.querySelector(`table#Table2 > tbody`);
      for(let i = 0; i < 17; i++){
        summary.push({
