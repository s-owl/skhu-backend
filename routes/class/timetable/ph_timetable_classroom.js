...
const url = "https://forest.skhu.ac.kr/GATE/SAM/LESSON/A/SSEA32S.ASPX?maincd=O&systemcd=S&seq=1";
const YEAR = system.args[1] == undefined ? "" : system.args[1];
const SEMESTER = system.args[2] == undefined ? "" : system.args[2];
const ROOMCODE = system.args[3] == undefined ? "" : system.args[3];
const BUILDING = system.args[4] == undefined ? "" : system.args[4];
const NAME = system.args[5] == undefined ? "" : system.args[5];
const PLACECODE = system.args[6] == undefined ? "" : system.args[6];
const COOKIE1_domain = system.args[7];
const COOKIE1_httponly = system.args[8];
const COOKIE1_name = system.args[9];
const COOKIE1_path = system.args[10];
const COOKIE1_secure = system.args[11];
const COOKIE1_value = system.args[12];
const COOKIE2_domain = system.args[13];
const COOKIE2_httponly = system.args[14];
const COOKIE2_name = system.args[15];
const COOKIE2_path = system.args[16];
const COOKIE2_secure = system.args[17];
const COOKIE2_value = system.args[18];
const COOKIE3_domain = system.args[19];
const COOKIE3_httponly = system.args[20];
const COOKIE3_name = system.args[21];
const COOKIE3_path = system.args[22];
const COOKIE3_secure = system.args[23];
const COOKIE3_value = system.args[24];
const COOKIE4_domain = system.args[25];
const COOKIE4_httponly = system.args[26];
const COOKIE4_name = system.args[27];
const COOKIE4_path = system.args[28];
const COOKIE4_secure = system.args[29];
const COOKIE4_value = system.args[30];
...
page.onLoadFinished = function(status) {
	if(submited==false){
		page.evaluate((year, semester, roomcode, building, name, placecode) => {
...
page.onResourceReceived = function(response){
	const doneurl = "https://forest.skhu.ac.kr/GATE/SAM/LESSON/A/SSEA32S.ASPX?maincd=O&systemcd=S&seq=1";
