...
var url = "https://forest.skhu.ac.kr/Gate/SAM/Lesson/COREControl/SSEX02O.aspx?id=objStaff&arg1=1&arg2=";
var RBLSEARCH = system.args[1] == undefined ? "" : system.args[1];
var SEARCH = system.args[2] == undefined ? "" : system.args[2];
...
page.onLoadFinished = function(status) {
  if(submited==false){
  page.evaluate(function(rblSearch, search){
    // Set Value on Input
    document.querySelector("#rblSearch").value = rblSearch;
    document.querySelector("#txtSearch").value = search;
    // Submit
...
page.onResourceReceived = function(response){
    var doneurl = "https://forest.skhu.ac.kr/Gate/SAM/Lesson/COREControl/SSEX02O.aspx?id=objStaff&arg1=1&arg2=";
