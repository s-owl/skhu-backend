...
const url = "https://forest.skhu.ac.kr/Gate/SAM/Lesson/COREControl/SSEX02O.aspx?id=objStaff&arg1=1&arg2=";
const RBLSEARCH = system.args[1] == undefined ? "" : system.args[1];
const SEARCH = system.args[2] == undefined ? "" : system.args[2];
...
page.onLoadFinished = function(status) {
	if(submited==false){
		page.evaluate((rblSearch, search) => {
			// Set Value on Input
...
page.onResourceReceived = function(response){
	const doneurl = "https://forest.skhu.ac.kr/Gate/SAM/Lesson/COREControl/SSEX02O.aspx?id=objStaff&arg1=1&arg2=";
